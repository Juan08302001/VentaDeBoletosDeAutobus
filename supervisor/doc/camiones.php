...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(70,10,'Reporte de existencia de camiones',0,0,'C');
    // Salto de línea
    $this->Ln(20);
	...
	$this->Cell(50,10,'Choferes',1,1,'C',0);
...
while ($row=$resultado->fetch_assoc()) {
	...
	$pdf->Cell(30,10,$row['num'],1,0,'C',0);
	$pdf->Cell(50,10,$row['asientos'],1,0,'C',0);
    $pdf->Cell(50,10,$row['choferes'],1,1,'C',0);
